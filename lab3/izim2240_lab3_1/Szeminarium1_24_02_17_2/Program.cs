...
namespace Szeminarium1_24_02_17_2
{
    internal static class Program
    {
        ...
        private static GlBarrel? glBarrel;

        private static GlBarrel? glBarrelNormal;
        ...
        private static unsafe void DrawBarrel()
        {
            // set material uniform to rubber

            var modelMatrixForBarrel = Matrix4X4.CreateScale((float)cubeArrangementModel.CenterCubeScale);
            modelMatrixForBarrel.M42 += 0.5f;
            SetModelMatrix(modelMatrixForBarrel);
            Gl.BindVertexArray(glBarrel.Vao);
            Gl.DrawElements(GLEnum.Triangles, glBarrel.IndexArrayLength, GLEnum.UnsignedInt, null);
            Gl.BindVertexArray(0);
        }
        private static unsafe void DrawBarrelNormal()
        {
            // set material uniform to rubber
            ...
            SetModelMatrix(modelMatrixForBarrel);
            Gl.BindVertexArray(glBarrelNormal.Vao);
            Gl.DrawElements(GLEnum.Triangles, glBarrelNormal.IndexArrayLength, GLEnum.UnsignedInt, null);
            Gl.BindVertexArray(0);
        }
        ...
        private static unsafe void SetUpObjects()
        {
            ...
            glBarrel = GlBarrel.CreateBarrel(Gl, face2Color, false);
            glBarrelNormal = GlBarrel.CreateBarrel(Gl, face2Color, true);
        ...
        private static void Window_Closing()
        {
            ...
            glBarrel.ReleaseGlBarrel();
            glBarrelNormal.ReleaseGlBarrel();
        }
